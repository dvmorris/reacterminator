...
module.exports = function processAllFormattedSnippets ({components, options}) {
  ...
  generateReadonlyIndexes({folderPath: actionTypeConstantsPath, type: 'constants'})
...
`
  ...
  generateReadonlyIndexes({folderPath: actionCreatorsPath, type: 'constants'})
  ...
  generateReadonlyIndexes({folderPath: reducersPath, type: 'reducers'})
