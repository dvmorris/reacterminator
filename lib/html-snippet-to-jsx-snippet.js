...
var changeLinksForParamStore = require('./html-snippet-to-jsx-snippet/change-links-for-param-store')
...
function htmlSnippetToJsxSnippet (component, options) {
  // ---------- CHEERIO START
  ...
  var jsxResult = _({component: component, ast: component.ast})
    .thru(redux.processJsx)
    .value()
